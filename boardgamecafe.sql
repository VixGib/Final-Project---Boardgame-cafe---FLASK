...
insert into review values(12, "Loved this game, great fun with the family!", 4, "2023-01-16", 24, 3);
insert into review values(13, "Fantastic game, great place to visit with the family, will be back!", 5, "2022-11-29", 24, 18);
insert into review values(14, "What a find this place is! kids loved it and a great game selection", 4, "2023-03-17", 24, 10);
insert into review values(15, "Good game but kids weren't a fan!", 3, "2023-04-26", 2, 15);
insert into review values(16, "Loved this game, kept us enthrawled for hours!", 4, "2022-11-06", 14, 15);
insert into review values(17, "Fantastic game and great place to visit!", 5, "2023-02-16", 20, 15); 
insert into review values(18, "Great fun with the family!", 5, "2022-11-26", 3, 5);
insert into review values(19, "Really great game", 4, "2023-03-06", 7, 5);
insert into review values(20, "Best game ever!", 4, "2023-02-16", 10, 5);
...
delete from cafesession where session_id = 1;
update cafesession set session_date = "2023-05-11" where session_id = 1;
update cafesession set session_date = "2023-05-9" where session_id = 2;
update cafesession set session_date = "2023-05-9" where session_id = 3;
update cafesession set session_date = "2023-05-10" where session_id = 4;
update cafesession set session_date = "2023-05-10" where session_id = 5;
update cafesession set session_date = "2023-05-10" where session_id = 6;
update cafesession set session_date = "2023-05-11" where session_id = 7;
update cafesession set session_date = "2023-05-11" where session_id = 8;
update cafesession set session_date = "2023-05-12" where session_id = 9;